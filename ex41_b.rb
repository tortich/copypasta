...
ROOMS = {
  ...
  :central_corridor => method(:central_corridor),
	:central_corridor_info => method(:central_corridor_info),
...
def runner(map, start)
	...
	while true
		...
		# room has now the function "def central_corridor_info" stored in it
		room = map[next_one]
...
runner(ROOMS, :central_corridor_info)